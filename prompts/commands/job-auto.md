...
- a search-results batch in `user/jobhub.db`, whose id the digest names
...
This has already cost something concrete: an application recorded on 2026-08-21 has
...
## Before you submit
- [ ] Warm path checked — alumni of a previous employer or training program at this company?
...
Report per role: packet path, fit verdict, eval verdict, and anything left open. Then give the
batch total and name anything that failed and why.
