...
def check_skills(md, rules):
    ...
    Added 2026-09-11, after Andre disclosed that the Go in personal-projects.md is
    agent-produced and he cannot write or debug it unaided. Go was on ten resumes'
