...
Usage:
    python3 scripts/build_resume.py user/tailored/{company}/senior-fullstack-software-engineer
...
Expected markdown shape:
    ...
    **Title**
    ...
    NOTE: do NOT hand-write a contact line. Name, title, location, email, phone and links
    are injected from user/config.yaml via the template ({{LOCATION}} etc). This docstring
    previously showed "**Title** | Location | email | phone" as the expected second line;
    five resumes followed it and hand-wrote his home town and state -- into the
    source, against the 2026-08-18 rule that location is ALWAYS "New Jersey" and never a
    town. The renderer discarded those lines so nothing shipped wrong, but the markdown was
    wrong for weeks and no check looked at it. resume_preflight.check_location() now does.
...
def render_experience(lines):
    ...
    for line in lines:
        ...
        if s.startswith("### "):
            ...
            # employment dates at all. Found 2026-08-21 on two tailored
            ...
            # Fixed 2026-08-20.
            # REFUSED as of 2026-08-21. The user: "Again adding boldened sub sections."
            # "Again" because they had said it before, nothing was written down, and it came
