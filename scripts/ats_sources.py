...
EMPLOYERS = {
    # Comcast: DEAD 2026-08-28. The wd5/comcast/Comcast_Careers CXS endpoint returns
    # HTTP 410 Gone, and Comcast_Careers2, Comcast_Careers_External, External_Careers
    # and bare Comcast all 303 to HTML rather than JSON; wd1 422s on every site name.
    # They have moved off this tenant. Disabled rather than left failing every run --
    # a scan log full of expected errors is how a real failure gets missed.
    # To revive: open jobs.comcast.com, grep the page for myworkdayjobs.com, and read
    # the tenant and site out of the URL.
