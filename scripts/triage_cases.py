...
"AI roles" as an exclusion without qualification, and the model dropped a
*Senior SWE, Developer Platform* req -- a role the user actually
...
# CLOSED_COMPANIES comes from user/closed-companies.txt, which is personal data.
# Pin it so veto_closed_company tests the mechanism rather than the local user/.
vetoes.CLOSED_COMPANIES = {'closedco'}

# (name, expect_keep, posting). expect_keep is what a correct screen produces.
CASES = [
    ('charter_dx_with_ai', True, {
        'company': 'Acme', 'title': 'Senior Software Engineer, Developer Platform',
    ...
    ('veto_ten_years', False, {
        'company': 'Globex', 'title': 'Senior Software Engineer, Web Infrastructure',
        'location': 'Remote US', 'is_remote': True,
